...
public class PdfGenerator {
	...
	public String transactionForCustomer(long transId, double updateBalance) {
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream("C:\\Users\\isha.swaroop\\Desktop\\Project Statement/Transaction" + transId
							+ "ForCustomer" + customer.getId() + ".pdf"));
			path = "C:\\Users\\isha.swaroop\\Desktop\\Project Statement/Transaction" + transId + "ForCustomer"
					+ customer.getId() + ".pdf";
			document.open();
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\isha.swaroop\\Desktop\\Project Statement/TransactionStatementForCustomerId"
									+ customerId + ".pdf"));
			path = "C:\\Users\\isha.swaroop\\Desktop\\Project Statement/TransactionStatementForCustomerId" + customerId
					+ ".pdf";
			document.open();
	...
	public String showAllTransactionsAndStatementForCustomerIdAndBillingDatePdf(List<Transaction> listTransaction,
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\isha.swaroop\\Desktop\\Project Statement/StatementForCustomerIdAndMonth"
									+ customerId + ".pdf"));
			path = "C:\\Users\\isha.swaroop\\Desktop\\Project Statement/StatementForCustomerIdAndMonth" + customerId
					+ ".pdf";
			document.open();
	...
	public String showBilledStatementWithAllTransactionsForCustomerIdAndBillingDatePdf(
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\isha.swaroop\\Desktop\\Project Statement/BilledStatementForCustomerIdAndMonth"
									+ customerId + ".pdf"));
			path = "C:\\Users\\isha.swaroop\\Desktop\\Project Statement/BilledStatementForCustomerIdAndMonth"
					+ customerId + ".pdf";
			document.open();
	...
	public String showUnBilledStatementWithAllTransactionsForCustomerIdAndBillingDatePdf(
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(
					"C:\\Users\\isha.swaroop\\Desktop\\Project Statement/UnBilledStatementForCustomerIdAndMonth"
							+ customerId + ".pdf"));
			path = "C:\\Users\\isha.swaroop\\Desktop\\Project Statement/UnBilledStatementForCustomerIdAndMonth"
					+ customerId + ".pdf";
			document.open();
			document.add(new Paragraph("                       BILLED STATEMENT FOR CUSTOMER ID " + customerId
